        ...
        <div class="col-xl-8 col-lg-7">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Viewership Overview</h6>
                </div>
                <div class="card-body">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-4 text-center small">
                        <span class="mr-1">
                            <i class="fas fa-circle text-primary"></i> PROJECT
                        </span>
                        <span class="mr-1">
                            <i class="fas fa-circle text-success"></i> TEAM
                        </span>
                        <span class="mr-1">
                            <i class="fas fa-circle text-info"></i> USERS
                        </span>
                        <span class="mr-1">
                            <i class="fas fa-circle text-warning"></i> NOTIFICATION
                        </span>
                    </div>
                </div>
            </div>
