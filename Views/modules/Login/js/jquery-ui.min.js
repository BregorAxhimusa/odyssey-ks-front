...
(function (e) {
	...
	function a(t) {
		...
		return t
			.delegate(i, 'mouseout', function () {
				e(this).removeClass('ui-state-hover'), -1 !== this.className.indexOf('ui-datepicker-prev') &&
					e(this).removeClass('ui-datepicker-prev-hover'), -1 !== this.className.indexOf('ui-datepicker-next') &&
	...
	e.extend(n.prototype, {
			...
			_findPos: function (t) {
				for (
					var i, s = this._getInst(t), n = this._get(s, 'isRTL'); t && ('hidden' === t.type || 1 !== t.nodeType || e.expr.filters.hidden(t));
					...
					for (k = '', this.maxRows = 4, T = 0; K[1] > T; T++) {
						...
						for (
							...
							for (
								M += '<tr>',
								E = d ?
								"<td class='ui-datepicker-week-col'>" + this._get(e, 'calculateWeek')(H) + '</td>' :
								'',
								x = 0; 7 > x; x++
							)
				...
				if ((y || (b += _ + (!a && g && v ? '' : '&#xa0;')), !e.yearshtml))
					if (((e.yearshtml = ''), a || !v)) b += "<span class='ui-datepicker-year'>" + i + '</span>';
						...
						for (
							...
							e.yearshtml +=
							"<select class='ui-datepicker-year' data-handler='selectYear' data-event='change'>"; m >= f; f++
						)
							e.yearshtml +=
							"<option value='" +
							f +
					...
					h = function (t, s) {
						e(t).each(function () {
							var t = e(this),
								...
								s && s.length ?
								s :
								t.parents(i.originalElement[0]).length ? ['width', 'height'] : ['width', 'height', 'top', 'left'];
							e.each(o, function (e, t) {
									var i = (n[t] || 0) + (r[t] || 0);
									i && i >= 0 && (a[t] = i || null);
								}),
			...
			(u.hsla.to = function (e) {
				...
				return (
					(t =
						...
						(60 * (a - s)) / l + 120 :
						(60 * (s - n)) / l + 240),
					(i = 0 === l ? 0 : 0.5 >= d ? l / u : l / (2 - u)), [Math.round(t) % 360, i, d, null == o ? 1 : o]
				);
			}),
				...
				toggleClass: (function (t) {
					return function (i, s, n, a, o) {
						return 'boolean' == typeof s || void 0 === s ?
							n ?
							e.effects.animateClass.call(this, s ? {
								add: i
							} : {
								remove: i
							}, n, a, o) :
	...
	e.effects,
		...
		e.widget('ui.selectmenu', {
			...
			_setOption: function (e, t) {
				'icons' === e &&
					this.button.find('span.ui-icon').removeClass(this.options.icons.button).addClass(t.button),
					this._super(e, t),
