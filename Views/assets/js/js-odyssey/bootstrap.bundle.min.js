...
!(function(t, e) {
            ...
            fn: function(t) {
                ...
                null != e.modifiersData.popperOffsets &&
                    ...
                    (e.attributes.popper = Object.assign(
                        Object.assign({}, e.attributes.popper), {}, { 'data-popper-placement': e.placement }
                    ));
            },
            data: {}
        },
    ...
    function Kt(t) {
        return Object.assign(
            Object.assign({}, t), {}, { left: t.x, top: t.y, right: t.x + t.width, bottom: t.y + t.height }
        );
    }
                ...
                (function(t) {
                    ...
                    return (
                        ...
                        ((o = i.width),
                            ...
                            ((s = i.offsetLeft), (a = i.offsetTop))), { width: o, height: r, x: s + Ht(t), y: a }
                    );
                })(t)
            ) :
            ft(e) ?
            ...
            Kt(
                (function(t) {
                    var e = _t(t),
                        ...
                        a = -n.scrollTop;
                    return (
                        'rtl' === mt(i || e).direction && (s += Math.max(e.clientWidth, i ? i.clientWidth : 0) - o), { width: o, height: r, x: s, y: a }
                    );
                })(_t(t))
            );
    }
    ...
    var $t = {
            ...
            fn: function(t) {
                ...
                (e.attributes.popper = Object.assign(
                    Object.assign({}, e.attributes.popper), {}, { 'data-popper-reference-hidden': u, 'data-popper-escaped': f }
                ));
            }
        },
        Gt = {
                    ...
                    s = st.reduce(function(t, n) {
                        return (
                            (t[n] = (function(t, e, n) {
                                ...
                                return (
                                    (s = s || 0),
                                    (a = (a || 0) * o), [it, nt].indexOf(i) >= 0 ? { x: a, y: s } : { x: s, y: a }
                                );
                            })(n, e.rects, r)),
                            t
                        );
        ...
        return (
            ...
            (('body' !== lt(e) || Rt(r)) &&
                (l =
                    ...
                    Bt(i)),
                ft(e) ? (((c = Mt(e)).x += e.clientLeft), (c.y += e.clientTop)) : r && (c.x = Ht(r))), { x: s.left + l.scrollLeft - c.x, y: s.top + l.scrollTop - c.y, width: s.width, height: s.height }
        );
    }
            ...
            return (
                ...
                (r._getConfig = function(t) {
                    ...
                    return (
                        ...
                        'number' ==
                        typeof(t = n({}, this.constructor.Default, e, 'object' == typeof t && t ? t : {})).delay &&
    ...
    var Ke = { animation: 'boolean', autohide: 'boolean', delay: 'number' },
        ...
        ze = (function(t) {
            function o(e, n) {
                var i;
                return (
                    ((i = t.call(this, e) || this)._config = i._getConfig(n)), (i._timeout = null), i._setListeners(), i
                );
            }
            i(o, t);
            var r = o.prototype;
