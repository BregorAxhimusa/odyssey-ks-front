    ...
    function Y(e) {
        ...
        e.events.keyboard = c('keydown', {
            ...
            withCallback: function(t, i) {
                ...
                if (9 == n) {
                    var l = !(!document.activeElement || !document.activeElement.nodeName) &&
                    ...
                    if (r && ((P = s.targetTouches[0]), !x && !S)) {
                        ...
                        if (
                            (Math.abs(v) > Math.abs(m) ? ((L = !1), (I = !0)) : ((I = !1), (L = !0)),
                                ...
                                ((d = 1 - Math.abs(t) / l),
                                    (h.style.opacity = d),
                                    e.settings.touchFollowAxis && (A = 0)), !c)
                        )
                ...
                n(e, [{
                    ...
                    },
                    {
                        ...
                        value: function(e, t) {
                            var i = this,
                                ...
                                l = {
                                    ...
                                    slideConfig: P(this.prevActiveSlideIndex) ?
                                        null : this.elements[this.prevActiveSlideIndex].slideConfig,
                                    trigger: P(this.prevActiveSlideIndex) ?
                                        null : this.elements[this.prevActiveSlideIndex].node,
                            ...
                            if (
                                (n.offsetWidth > 0 && s && (y(s), (s.style.display = '')), u(e, this.effectsClasses), t)
                            )
                    ...
                    },
                    {
                        ...
                        value: function() {
                            var e = this,
                                t = [];
                            (this.elements = this.elements ? this.elements : []), !P(this.settings.elements) &&
