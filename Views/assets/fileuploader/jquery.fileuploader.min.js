                ...
                f = {
                    ...
                    redesign: function() {
                        ...
                        n.thumbnails && f.thumbnails.create(),
                            n.dragDrop &&
                            ((n.dragDrop = 'object' != typeof n.dragDrop ? { container: null } : n.dragDrop),
                    ...
                    set: function(e, t) {
                        switch (e) {
                            case 'attrOpts':
                                for (
                                    ...
                                    if (f._assets.hasAttr(a))
                                        switch (i[r]) {
                                            ...
                                            case 'addMore':
                                            case 'listInput':
                                                n[i[r]] = -1 < ['true', 'false'].indexOf(s.attr(a)) ?
                                                    'true' == s.attr(a) :
                                                    s.attr(a);
                                                break;
                                            case 'extensions':
                                ...
                                (null == s.attr('disabled') && null == s.attr('readonly') && 0 !== n.limit) ||
                                (f.disabled = !0),
                                (!n.limit || (n.limit && 2 <= n.limit)) &&
                                (s.attr('multiple', 'multiple'),
                                    n.inputNameBrackets &&
                                    '[]' != s.attr('name').slice(-2) &&
                                    s.attr('name', s.attr('name') + '[]')), !0 === n.listInput &&
                                    (n.listInput = $(
                                        '<input type="hidden" name="fileuploader-list-' +
                                        s.attr('name').replace('[]', '').split('[').pop().replace(']', '') +
                                        '">'
                                    ).insertBefore(s)),
                                    ...
                                    f.set('disabled', f.disabled), !n.fileMaxSize && n.maxSize && (n.fileMaxSize = n.maxSize);
                                break;
                            case 'disabled':
                                (f.disabled = t),
                            ...
                            case 'feedback':
                                t ||
                                    (t = f._assets.textParse(
                                        0 < f._itFl.length ? n.captions.feedback2 : n.captions.feedback, { length: f._itFl.length }
                                    )),
                            ...
                            case 'nextInput':
                                ...
                                f.bindUnbindEvents(!1),
                                    0 < sl.length && 0 == sl[sl.length - 1].get(0).files.length ?
                                    (s = sl[sl.length - 1]) :
                                    (-1 == sl.indexOf(s) && sl.push(s), sl.push(l), s.after((s = l))),
                                    f.bindUnbindEvents(!0);
                                break;
                            case 'listInput':
                    ...
                    onChange: function(e, t) {
                        ...
                        if (
                            (f.clipboard._timer && f.clipboard.clean(), !f.isDefaultMode() || (f.reset(), 0 != i.length))
                        ) {
                            if (n.beforeSelect && $.isFunction(n.beforeSelect) && 0 == n.beforeSelect(i, l, p, o, s))
                                return !1;
                            for (var r = 0, a = 0; a < i.length; a++) {
                                ...
                                if (!0 === c)
                                    ...
                                    (f.files.remove(u, !0),
                                        c[2] ||
                                        (f.isDefaultMode() && (f.set('input', ''), f.reset(), (c[3] = !0)),
                    ...
                    thumbnails: {
                                ...
                                l.on('click', n.thumbnails._selectors.remove, function(e) {
                                    ...
                                    i &&
                                        (i.upload && 'successful' != i.upload.status ?
                                            ...
                                            n.dialogs.confirm(
                                                f._assets.textParse(n.captions.removeConfirmation, i),
                                                t
                                            ) :
                                            t());
                                });
                        ...
                        item: function(t, e) {
                            ...
                            (t.progressBar = f.isUploadMode() ?
                                '<div class="fileuploader-progressbar"><div class="bar"></div></div>' :
                                ''),
                            (t.html = $(
                                f._assets.textParse(
                                    t.appended && n.thumbnails.item2 ? n.thumbnails.item2 : n.thumbnails.item,
                                    t
                                )
                            )),
                            ...
                            t.html.addClass(
                                    'file-type-' +
                                    (t.format ? t.format : 'no') +
                                    ' file-ext-' +
                                    (t.extension ? t.extension : 'no')
                                ),
                                e ?
                                ...
                                (t.renderThumbnail = function(e) {
                                    e &&
                                        t.popup &&
                                        t.popup.close &&
                                        (t.popup.close(), (t.popup = { open: t.popup.open })),
                        ...
                        generateFileIcon: function(e, t) {
                            ...
                            i &&
                                (f._assets.isBrightColor(i) && (o = o.replace('${class}', ' is-bright-color')),
                                    (o = o.replace('${style}', 'background-color: ' + i)));
                            return o.replace('${style}', '').replace('${class}', '');
                        },
                        renderThumbnail: function(d, e, t) {
                            function u(e) {
                                var t = $(e);
                                c.removeClass('fileuploader-no-thumbnail fileuploader-loading').html(t),
                                    d.popup && d.html.addClass('file-has-popup'),
                                    t.is('img') &&
                            ...
                            var c = d.html.find('.fileuploader-item-image'),
                                i = d.data && d.data.readerSkip,
                                h = function(e) {
                                    c.addClass('fileuploader-no-thumbnail'),
                                        c.removeClass('fileuploader-loading').html(d.icon),
                                        d.popup && d.html.addClass('file-has-popup'),
                                        e &&
                                        null != n.thumbnails.onImageLoaded &&
                                        $.isFunction(n.thumbnails.onImageLoaded) &&
                            ...
                            if (c.length) {
                                if (
                                    ((d.image = c.html('').addClass('fileuploader-loading')),
                                        (-1 < ['image', 'video', 'audio', 'astext'].indexOf(d.format) ||
                                            d.data.thumbnail) &&
                                        f.isFileReaderSupported() &&
                                        !i &&
                                        (d.appended || n.thumbnails.startImageRenderer || e))
                                ) {
                                    if (
                                        (d.html.removeClass('file-has-popup'),
                                            n.thumbnails.synchronImages &&
                                            (-1 != f._pfrL.indexOf(d) || e || f._pfrL.push(d),
                                                1 < f._pfrL.length && !e))
                                    )
                                        return;
                                    var r = function(e, t) {
                                        ...
                                        if (n.thumbnails.canvasImage) {
                                            var r = document.createElement('canvas'),
                                                ...
                                                l = function() {
                                                    f.editor.resize(
                                                        ...
                                                        f._assets.isBlankCanvas(r) ? h() : u(r),
                                                        m();
                                                },
                                                s = function(e) {
                                                    h(!0), m(), (a = null);
                                            ...
                                            (a.onerror = s),
                                            d.data &&
                                                d.data.readerCrossOrigin &&
                                                a.setAttribute('crossOrigin', d.data.readerCrossOrigin),
                                                (a.src = i);
                                        } else u(o ? e : '<img src="' + i + '">');
                                    };
                                    return 'string' == typeof t || 'object' == typeof t ?
                                        ...
                                        f.files.read(
                                            ...
                                            function() {
                                                d.reader.node &&
                                                    (d.reader.frame || 'img' == d.reader.node.nodeName.toLowerCase()) ?
                                                    r(d.reader.frame || d.reader.src, !0) :
                                                    (h('image' == d.format), m());
                                            },
                                            null,
                                            t, !0
                        ...
                        popup: function(d, r) {
                            if (!f.locked && n.thumbnails.popup && n.thumbnails._selectors.popup) {
                                var a = $(n.thumbnails.popup.container),
                                    ...
                                    e = function() {
                                        function t(e) {
                                            ...
                                            27 == t && d.popup && d.popup.close && d.popup.close(),
                                                (37 != t && 39 != t) ||
                                                !n.thumbnails.popup.arrows ||
                                                d.popup.move(37 == t ? 'prev' : 'next');
                                        }
                                        ...
                                        u.removeClass('loading'),
                                            ...
                                            (d.popup.move = function(e) {
                                                ...
                                                if (
                                                    'prev' ==
                                                    (e = n.thumbnails.itemPrepend ? ('prev' == e ? 'next' : 'prev') : e)
                                                )
                                                    for (var r = t; 0 <= r; r--) {
                                                        if (
                                                            (a = f._itFl[r]) != d &&
                                            ...
                                            (d.popup.close = function(e) {
                                                d.reader.node && d.reader.node.pause && d.reader.node.pause(),
                                                    $(window).off('keyup', t),
                                                    ...
                                                    d.popup.html && d.popup.html.remove(),
                                                    e ||
                                            ...
                                            (i &&
                                                ...
                                                .find('.reader-node')
                                                .html(d.reader.node),
                                                (d.reader.node.controls = !0),
                                                (d.reader.node.currentTime = 0),
                                                d.reader.node.play && d.reader.node.play()) :
                                            i &&
                                            e
                                            .find('.fileuploader-popup-node')
                                            .html(
                                                '<div class="reader-node"><div class="fileuploader-popup-file-icon">' +
                                                d.icon +
                                                '</div></div>'
                                            ),
                                            $(window).on('keyup', t),
                                            ...
                                            .removeAttr('style'),
                                            d.popup.html[
                                                1 != f._itFl.length && n.thumbnails.popup.arrows ?
                                                'addClass' :
                                                'removeClass'
                                            ]('fileuploader-popup-has-arrows'),
                                            n.thumbnails.popup.loop ||
                                            (0 == f._itFl.indexOf(d) &&
                                                d.popup.html.find('[data-action="prev"]').hide(),
                                                f._itFl.indexOf(d) == f._itFl.length - 1 &&
                                            ...
                                            (d.popup.editor || (d.popup.editor = {}),
                                                f.editor.rotate(
                                                    d,
                                                    d.popup.editor.rotation || d.editor.rotation || 0, !0
                                                ),
                                                d.popup.editor &&
                                                d.popup.editor.cropper &&
                                                (d.popup.editor.cropper.hide(!0),
                                                    setTimeout(function() {
                                                        f.editor.crop(
                                                            d,
                                                            d.editor.crop ?
                                                            $.extend({}, d.editor.crop) :
                                                            d.popup.editor.cropper.setDefaultData()
                                                        );
                                                    }, 100))),
                                            d.popup.html
                                ...
                                0 == u.length && (u = $('<div class="fileuploader-popup"></div>').appendTo(a)),
                                    u.fadeIn(400).addClass('loading'),
                                    (-1 < ['image', 'video', 'audio', 'astext'].indexOf(d.format) ||
                                        -1 < ['application/pdf'].indexOf(d.type)) &&
                                    !d.popup.html ?
                                    f.files.read(d, e) :
                                    e();
                            }
                    ...
                    editor: {
                        rotate: function(e, t, o) {
                            if (!(e.popup && e.popup.html && $('html').find(e.popup.html).length)) {
                                ...
                                return (
                                    360 <= n && (n = 0),
                                    e.popup.editor && (e.popup.editor.rotation = n),
                                    (e.editor.rotation = n)
                                );
                            }
                            if (e.reader.node) {
                                ...
                                e.popup.editor.cropper && e.popup.editor.cropper.$template.hide(),
                                    ...
                                    (e.popup.editor.scale = (
                                        r.height() /
                                        p[-1 < [90, 270].indexOf(e.popup.editor.rotation) ? 'width' : 'height']()
                                    ).toFixed(3)),
                                    p.height() * e.popup.editor.scale > r.width() &&
                                    -1 < [90, 270].indexOf(e.popup.editor.rotation) &&
                                    (e.popup.editor.scale = r.height() / p.width()),
                                    1 < e.popup.editor.scale && (e.popup.editor.scale = 1),
                                    $(a)
                                    .stop()
                                    .animate({ rotation: e.popup.editor.rotation, scale: e.popup.editor.scale }, {
                                        duration: o ? 2 : 300,
                                        easing: 'swing',
                                        step: function(e, t) {
                                            var o =
                                                p.css('-webkit-transform') ||
                                                p.css('-moz-transform') ||
                                                p.css('transform') ||
                                                'none',
                                                i = 0,
                                            ...
                                            if ('none' !== o) {
                                                ...
                                                (i =
                                                    'rotation' == r ?
                                                    e :
                                                    Math.round(Math.atan2(s, l) * (180 / Math.PI))),
                                                (n =
                                                    'scale' == r ?
                                                    e :
                                                    Math.round(10 * Math.sqrt(l * l + s * s)) / 10);
                                            }
                                            p.css({
                        ...
                        crop: function(b, e) {
                            if (!(b.popup && b.popup.html && $('html').find(b.popup.html).length))
                                return (b.editor.crop = e || b.editor.crop);
                            if (b.reader.node)
                                if (b.popup.editor.cropper)
                                    e && (b.popup.editor.cropper.crop = e), b.popup.editor.cropper.init(e);
                                else {
                                    ...
                                    (b.popup.editor.cropper = {
                                        ...
                                        crop: e || null,
                                        init: function(o) {
                                            var i = b.popup.editor.cropper,
                                                e = i.$imageEl.position(),
                                                t = i.$imageEl[0].getBoundingClientRect().width,
                                                r = i.$imageEl[0].getBoundingClientRect().height,
                                                a =
                                                b.popup.editor.rotation &&
                                                -1 < [90, 270].indexOf(b.popup.editor.rotation) ?
                                                b.popup.editor.scale :
                                                1;
                                            if ((i.hide(), i.crop || i.setDefaultData(), 0 == t || 0 == r))
                                                return i.hide(!0);
                                            i.isCropping ||
                                                (i.$imageEl.clone().appendTo(i.$template.find('.area-image')),
                                                    i.$imageEl.parent().append(l)),
                                                i.$template
                                                .hide()
                                                .css({ left: e.left, top: e.top, width: t, height: r })
                                                .fadeIn(150),
                                                i.$editor.hide(),
                                                    ...
                                                    if (
                                                        (delete i._editorAnimationTimeout,
                                                            ...
                                                            (n.editor.cropper.maxWidth &&
                                                                (i.crop.width = Math.min(
                                                                    n.editor.cropper.maxWidth * i.crop.cfWidth,
                                                                    i.crop.width
                                                                )),
                                                                n.editor.cropper.maxHeight &&
                                                                (i.crop.height = Math.min(
                                                                    n.editor.cropper.maxHeight * i.crop.cfHeight,
                                                                    i.crop.height
                                                                )),
                                                                (b.editor.crop && 'rotation' != o) ||
                                                                'resize' == o ||
                                                                ((i.crop.left =
                                                                        (i.$template.width() - i.crop.width) / 2),
                                                                    (i.crop.top =
                                                                        (i.$template.height() - i.crop.height) / 2))),
                                                            (!b.editor.crop || 'rotation' == o) &&
                                                            n.editor.cropper &&
                                                ...
                                                (e ?
                                                    (o.$template.hide(),
                                                        ...
                                                        (o._resizeTimeout = setTimeout(function() {
                                                            ...
                                                            var e = i.width() / b.reader.width,
                                                                t = i.height() / b.reader.height;
                                                    ...
                                                    ((o.crop.cfWidth = i.width() / b.reader.width),
                                                        (o.crop.cfHeight = i.height() / b.reader.height)));
                                        },
                                        drawPlaceHolder: function(e) {
                                            var t = b.popup.editor.cropper,
                                                o = b.popup.editor.rotation || 0,
                                                i = b.popup.editor.scale || 1,
                                                n = [0, 0];
                                            e &&
                                                ((e = $.extend({}, e)),
                                                    o &&
                                        ...
                                        setAreaInfo: function(e) {
                                            var t = b.popup.editor.cropper,
                                                o = b.popup.editor.scale || 1;
                                            t.$editor
                                                .find('.area-info')
                                                .html(
                                                    (t.isResizing || 'size' == e ? [
                                                        'W: ' +
                                                        Math.round(t.crop.width / t.crop.cfWidth / o) +
                                                        'px',
                                                        ' ',
                                                        'H: ' +
                                                        Math.round(t.crop.height / t.crop.cfHeight / o) +
                                                        'px'
                                                    ] : [
                                                        'X: ' +
                                                        Math.round(t.crop.left / t.crop.cfWidth / o) +
                                                        'px',
                                                        ' ',
                                                        'Y: ' +
                                                        Math.round(t.crop.top / t.crop.cfHeight / o) +
                                                        'px'
                                                    ]).join('')
                                                );
                                        },
                                        mousedown: function(e) {
                                            ...
                                            (b.popup.zoomer && b.popup.zoomer.hasSpacePressed) ||
                                        ...
                                        mousemove: function(e) {
                                            var t =
                                                ...
                                                'touchstart' :
                                                'mousedown',
                                                o = ($(e.target), b.popup.editor.cropper),
                                                i = {
                                                    x:
                                                        ('mousedown' == t ?
                                                            e.pageX :
                                                            e.originalEvent.touches[0].pageX) -
                                                        o.$template.offset().left,
                                                    y:
                                                        ('mousedown' == t ?
                                                            e.pageY :
                                                            e.originalEvent.touches[0].pageY) -
                                                        o.$template.offset().top
                                                };
                                            ...
                                            if (o.isMoving) {
                                                ...
                                                r + o.crop.width > o.$template.width() &&
                                                    (r = o.$template.width() - o.crop.width),
                                                    r < 0 && (r = 0),
                                                    a + o.crop.height > o.$template.height() &&
                                                    (a = o.$template.height() - o.crop.height),
                                                    a < 0 && (a = 0),
                                                    (o.crop.left = r),
                                                    (o.crop.top = a);
                                            }
                                            if (o.isResizing) {
                                                var l,
                                                    s = o.pointData.el.attr('class').substr('point point-'.length),
                                                    p = o.crop.left + o.crop.width,
                                                    d = o.crop.top + o.crop.height,
                                                    u =
                                                    ((n.editor.cropper && n.editor.cropper.minWidth) || 0) *
                                                    o.crop.cfWidth,
                                                    c =
                                                    ((n.editor.cropper && n.editor.cropper.minHeight) || 0) *
                                                    o.crop.cfHeight,
                                                    h =
                                                ...
                                                if (
                                                    (u > o.$template.width() && (u = o.$template.width()),
                                                        c > o.$template.height() && (c = o.$template.height()),
                                                        h > o.$template.width() && (h = o.$template.width()),
                                                        m > o.$template.height() && (m = o.$template.height()),
                                                        ('a' == s || 'b' == s || 'c' == s) &&
                                                        !l &&
                                                        ((o.crop.top = i.y),
                                                            o.crop.top < 0 && (o.crop.top = 0),
                                                            (o.crop.height = d - o.crop.top),
                                                            o.crop.top > o.crop.top + o.crop.height &&
                                                            ((o.crop.top = d), (o.crop.height = 0)),
                                                            o.crop.height < c &&
                                                            ((o.crop.top = d - c), (o.crop.height = c)),
                                                            o.crop.height > m &&
                                                            ((o.crop.top = d - m), (o.crop.height = m)),
                                                            (l = g ?
                                                                f._assets.ratioToPx(o.crop.width, o.crop.height, g) :
                                                                null) &&
                                                            ((o.crop.width = l[0]),
                                                                ('a' != s && 'b' != s) ||
                                                                (o.crop.left = Math.max(
                                                                    0,
                                                                    o.pointData.left +
                                                                    (o.pointData.width - o.crop.width) /
                                                                    ('b' == s ? 2 : 1)
                                                                )),
                                                                o.crop.left + o.crop.width > o.$template.width())))
                                                ) {
                                                    var v = o.$template.width() - o.crop.left;
                                                    (o.crop.width = v),
                                                    (o.crop.height = (v / l[2]) * l[3]),
                                                    (o.crop.top = d - o.crop.height);
                                                }
                                                if (
                                                    ('e' == s || 'f' == s || 'g' == s) &&
                                                    !l &&
                                                    ((o.crop.height = i.y - o.crop.top),
                                                        o.crop.height + o.crop.top > o.$template.height() &&
                                                        (o.crop.height = o.$template.height() - o.crop.top),
                                                        o.crop.height < c && (o.crop.height = c),
                                                        o.crop.height > m && (o.crop.height = m),
                                                        (l = g ?
                                                            f._assets.ratioToPx(o.crop.width, o.crop.height, g) :
                                                            null) &&
                                                        ((o.crop.width = l[0]),
                                                ...
                                                if (
                                                    ('c' == s || 'd' == s || 'e' == s) &&
                                                    !l &&
                                                    ((o.crop.width = i.x - o.crop.left),
                                                        o.crop.width + o.crop.left > o.$template.width() &&
                                                        (o.crop.width = o.$template.width() - o.crop.left),
                                                        o.crop.width < u && (o.crop.width = u),
                                                        o.crop.width > h && (o.crop.width = h),
                                                        (l = g ?
                                                            f._assets.ratioToPx(o.crop.width, o.crop.height, g) :
                                                            null) &&
                                                        ((o.crop.height = l[1]),
                                                            ...
                                                            (o.crop.top = Math.max(
                                                                0,
                                                                o.pointData.top +
                                                                (o.pointData.height - o.crop.height) /
                                                                ('d' == s ? 2 : 1)
                                                            )),
                                                            o.crop.top + o.crop.height > o.$template.height()))
                                                ) {
                                                ...
                                                if (
                                                    ...
                                                    ((o.crop.left = i.x),
                                                        ...
                                                        (o.crop.left = o.$template.width()),
                                                        o.crop.left < 0 && (o.crop.left = 0),
                                                        (o.crop.width = p - o.crop.left),
                                                        o.crop.left > o.crop.left + o.crop.width &&
                                                        ((o.crop.left = p), (o.crop.width = 0)),
                                                        o.crop.width < u && ((o.crop.left = p - u), (o.crop.width = u)),
                                                        o.crop.width > h && ((o.crop.left = p - h), (o.crop.width = h)),
                                                        (l = g ?
                                                            f._assets.ratioToPx(o.crop.width, o.crop.height, g) :
                                                            null) &&
                                                        ((o.crop.height = l[1]),
                                                    ...
                                                    (o.crop.height = w),
                                                    (o.crop.width = (w / l[3]) * l[2]),
                                                    (o.crop.left = p - o.crop.width);
                                                }
                                            }
                                        ...
                                        mouseup: function(e) {
                                            var t = b.popup.editor.cropper;
                                            (0 != t.$editor.width() && 0 != t.$editor.height()) ||
                        ...
                        resize: function(e, t, o, i, n, r) {
                            ...
                            if (((t.width = s), (t.height = p), e.width < t.width || e.height < t.height || d < 2)) {
                                r ||
                                    ((t.width = Math.min(e.width, t.width)), (t.height = Math.min(e.height, t.height)));
                                var u = e.width < t.width ? (t.width - e.width) / 2 : 0,
                                    c = e.height < t.height ? (t.height - e.height) / 2 : 0;
                                n || ((a.fillStyle = '#fff'), a.fillRect(0, 0, t.width, t.height)),
                                ...
                                for (
                                    ...
                                    h.drawImage(e, 0, 0, f.width, f.height); 2 < d;
                                    ...
                                    var g = m + 2,
                                        ...
                                        w = e.height / m;
                                    v > f.width && (v = f.width),
                                        w > f.height && (w = f.height),
                                        h.drawImage(f, 0, 0, v, w, 0, 0, e.width / g, e.height / g),
                                        (m = g),
                                        d--;
                                }
                        ...
                        zoom: function(s) {
                            if (s.popup && s.popup.html && $('html').find(s.popup.html).length) {
                                if (!s.popup.zoomer) {
                                    var e = s.popup.html,
                                        l = e.find('.fileuploader-popup-node'),
                                    ...
                                    s.popup.zoomer = {
                                        ...
                                        init: function() {
                                            ...
                                            e.hide(),
                                                ...
                                                p.on('mousedown touchstart', e.mousedown),
                                                l.on('mousewheel DOMMouseScroll', e.scroll);
                                        },
                                        hide: function() {
                                            var e = this;
                                            $(window).off('resize', e.resize),
                                                ...
                                                p.off('mousedown', e.mousedown),
                                                l.off('mousewheel DOMMouseScroll', e.scroll);
                                        },
                                        center: function(e) {
                                            var t = this,
                                                o = 0,
                                            ...
                                            (i = e ?
                                                ((o = t.left),
                                                    (i = t.top),
                                                    (o -= (l.width() / 2 - t.left) * (p.width() / e[0] - 1)),
                                                    (i -= (l.height() / 2 - t.top) * (p.height() / e[1] - 1)),
                                                    p.width() <= l.width() &&
                                                    (o = Math.round((l.width() - p.width()) / 2)),
                                                    p.height() <= l.height() &&
                                                    (i = Math.round((l.height() - p.height()) / 2)),
                                                    p.width() > l.width() &&
                                                    (0 < o ?
                                                        (o = 0) :
                                                        o + p.width() < l.width() && (o = l.width() - p.width())),
                                                    p.height() > l.height() &&
                                                    (0 < i ?
                                                        (i = 0) :
                                                        i + p.height() < l.height() &&
                                                    ...
                                                    Math.min(i, 0)) :
                                                ((o = Math.round((l.width() - p.width()) / 2)),
                                                    Math.round((l.height() - p.height()) / 2))),
                                            p.css({ left: (t.left = o) + 'px', top: (t.top = i) + 'px' });
                                        },
                                        resize: function() {
                                        ...
                                        range: function(e) {
                                            ...
                                            i < t.scale && (e.preventDefault(), (i = t.scale), o.val(i)),
                                                t.updateView(i, !0);
                                        },
                                        scroll: function(e) {
                                            var t = s.popup.zoomer,
                                                o = -100;
                                            e.originalEvent &&
                                                (e.originalEvent.wheelDelta && (o = e.originalEvent.wheelDelta / -40),
                                                    e.originalEvent.deltaY && (o = e.originalEvent.deltaY),
                                                    e.originalEvent.detail && (o = e.originalEvent.detail)),
                                        ...
                                        keyPress: function(e) {
                                            ...
                                            32 == (e.keyCode || e.which) &&
                                                ((t.hasSpacePressed = 'keydown' == o),
                                                    t.hasSpacePressed && t.isZoomed() ?
                                                    p.addClass('is-amoving') :
                                                    p.removeClass('is-amoving'));
                                        },
                                        mousedown: function(e) {
                                            function t() {
                                                (o.pointData = {
                                            ...
                                            1 == e.which &&
                                                100 != o.scale &&
                                                o.zoom != o.scale &&
                                                (o.hasSpacePressed || i[0] == d[0] || i.is('.fileuploader-cropper')) &&
                                                ('mousedown' == r && t(),
                                                    'touchstart' == r &&
                                        ...
                                        mousemove: function(e) {
                                            ...
                                            0 < a && (a = 0),
                                                a < l.height() - p.height() && (a = l.height() - p.height()),
                                                p.height() < l.height() && (a = l.height() / 2 - p.height() / 2),
                                                p.width() > l.width() ?
                                                (0 < r && (r = 0),
                                                    r < l.width() - p.width() && (r = l.width() - p.width())) :
                                                (r = l.width() / 2 - p.width() / 2),
                                                p.css({ left: (t.left = r) + 'px', top: (t.top = a) + 'px' });
                                        },
                                        mouseup: function(e) {
                                            var t = s.popup.zoomer;
                                            delete t.pointData,
                                        ...
                                        zoomIn: function(e) {
                                            var t = s.popup.zoomer,
                                                o = e || 20;
                                            100 <= t.zoom ||
                                                ((t.zoom = Math.min(100, t.zoom + o)), t.updateView(t.zoom));
                                        },
                                        zoomOut: function(e) {
                                            var t = s.popup.zoomer,
                                                o = e || 20;
                                            t.zoom <= t.scale ||
                                                ((t.zoom = Math.max(t.scale, t.zoom - o)), t.updateView(t.zoom));
                                        },
                                        updateView: function(e, t) {
                                            ...
                                            l
                                                ?
                                                p.addClass('is-movable').css({
                                                    width: i + 'px',
                                                    height: n + 'px',
                                                    maxWidth: 'none',
                                                    maxHeight: 'none'
                                                }) :
                                                p.removeClass('is-movable is-amoving').removeAttr('style'),
                                                (o.zoom = e || o.scale),
                                                ...
                                                e &&
                                                s.popup.editor &&
                                                s.popup.editor.cropper &&
                                                s.popup.editor.cropper.resize(!0);
                                        },
                                        isZoomed: function() {
                        ...
                        save: function(w, b, x, y, _) {
                            function e() {
                                if (w.reader.node) {
                                    var t = document.createElement('canvas'),
                                        ...
                                        e = [0, 180];
                                    if (
                                        ((t.width = w.reader.width),
                                            (t.height = w.reader.height),
                                            i.drawImage(this, 0, 0, w.reader.width, w.reader.height),
                                            void 0 !== w.editor.rotation)
                                    ) {
                                        (w.editor.rotation = w.editor.rotation || 0),
                                        (t.width = -1 < e.indexOf(w.editor.rotation) ? w.reader.width : w.reader.height),
                                        (t.height = -1 < e.indexOf(w.editor.rotation) ? w.reader.height : w.reader.width);
                                        var r = (w.editor.rotation * Math.PI) / 180,
                                            a = 0.5 * t.width,
                                            d = 0.5 * t.height;
                                        i.clearRect(0, 0, t.width, t.height),
                                            i.translate(a, d),
                                            i.rotate(r),
                                            i.translate(0.5 * -w.reader.width, 0.5 * -w.reader.height),
                                            i.drawImage(this, 0, 0),
                                            i.setTransform(1, 0, 0, 1, 0, 0);
                                    }
                                    if (w.editor.crop) {
                                        var u = i.getImageData(
                                            w.editor.crop.left,
                                            w.editor.crop.top,
                                            w.editor.crop.width,
                                            w.editor.crop.height
                                        );
                                        (t.width = w.editor.crop.width),
                                        (t.height = w.editor.crop.height),
                                        i.putImageData(u, 0, 0);
                                    }
                                    var c = x || w.type || 'image/jpeg',
                                        h = n.editor.quality || 90,
                                        m = t.toDataURL(c, h / 100),
                                        g = function(e, t) {
                                            var i = b ? f._assets.dataURItoBlob(e, c) : e;
                                            _ || f.thumbnails.renderThumbnail(w, !0, t || e),
                                                y && y(i, w, l, p, o, s),
                                                null != n.editor.onSave &&
                                                'function' == typeof n.editor.onSave &&
                                                n.editor.onSave(i, w, l, p, o, s),
                                                f.set('listInput', null);
                                        };
                                    if (n.editor.maxWidth || n.editor.maxHeight) {
                                        ...
                                        (v.onload = function() {
                                            ...
                                            f.editor.resize(v, e, n.editor.maxWidth, n.editor.maxHeight, !0, !1),
                                                (m = e.toDataURL(c, h / 100)),
                                                g(m, v),
                                                (t = i = e = null);
                                        });
                                    } else g(m), (t = i = null);
                            ...
                            var t = w.popup && w.popup.html && $('html').find(w.popup.html).length,
                                i = new Image();
                            if (t) {
                                if (!w.popup.editor.hasChanges) return;
                                var r = w.popup.editor.scale || 1;
                                (w.editor.rotation = w.popup.editor.rotation || 0),
                                w.popup.editor.cropper &&
                                    ((w.editor.crop = w.popup.editor.cropper.crop),
                                        (w.editor.crop.width =
                                            w.editor.crop.width / w.popup.editor.cropper.crop.cfWidth / r),
                                        (w.editor.crop.left =
                                            w.editor.crop.left / w.popup.editor.cropper.crop.cfWidth / r),
                                        (w.editor.crop.height =
                                            w.editor.crop.height / w.popup.editor.cropper.crop.cfHeight / r),
                                        (w.editor.crop.top =
                                            w.editor.crop.top / w.popup.editor.cropper.crop.cfHeight / r));
                            }
                            f._assets.isMobile() ?
                                ((i.onload = e), (i.src = w.reader.src)) :
                                w.reader.node ?
                                e.call(w.reader.node) :
                                w.reader.read(function() {
                                    e.call(w.reader.node);
                                });
                        }
                    },
                    sorter: {
                        ...
                        findItemAtPos: function(i) {
                            ...
                            return (
                                t.each(function(e, t) {
                                    ...
                                    if (
                                        i.x > o.offset().left &&
                                        i.x < o.offset().left + o.outerWidth() &&
                                        i.y > o.offset().top &&
                                        i.y < o.offset().top + o.outerHeight()
                                    )
                                        return (n = o), !1;
                                }),
                                n
                        ...
                        mousedown: function(e) {
                            function t() {
                                (f.sorter.sort = {
                                    ...
                                    placeholder: n.sorter.placeholder ?
                                        $(n.sorter.placeholder) : a.html.clone().addClass('fileuploader-sorter-placeholder').html('')
                                }),
                                $('body').css({
                                        '-webkit-user-select': 'none',
                                        '-moz-user-select': 'none',
                            ...
                            e.preventDefault(),
                                ...
                                ((n.sorter.selectorExclude &&
                                        (i.is(n.sorter.selectorExclude) ||
                                            i.closest(n.sorter.selectorExclude).length)) ||
                                    ($(n.thumbnails._selectors.sorter).on(
                                            'click drop dragend dragleave dragover dragenter dragstart touchstart touchmove touchend touchcancel',
                                            function(e) {
                                                e.preventDefault();
                                            }
                                        ),
                                            ...
                                            setTimeout(
                                                function() {
                                                    f.sorter.isTouchLongPress &&
                                                        (delete f.sorter.isTouchLongPress, t());
                                                },
                                                n.thumbnails.touchDelay ? n.thumbnails.touchDelay : 0
                                            )),
                        ...
                        mousemove: function(e) {
                            ...
                            var w = f.sorter.findItemAtPos({ x: h + o.xItem + s, y: m + o.yItem + p });
                            if (w) {
                                var b = o.placeholder.offset().left != w.offset().left,
                                    x = o.placeholder.offset().top != w.offset().top;
                                if (f.sorter.sort.lastHover && f.sorter.sort.lastHover.el == w[0]) {
                                    if (
                                        x &&
                                        'before' == f.sorter.sort.lastHover.direction &&
                                        c.y < f.sorter.sort.lastHover.y
                                    )
                                        return;
                                    if (
                                        x &&
                                ...
                                var y = r.index(i.html),
                                    _ = r.index(w) < y ? 'before' : 'after';
                                w[_](o.placeholder),
                                    w[_](i.html),
                                    (f.sorter.sort.lastHover = { el: w[0], x: c.x, y: c.y, direction: _ });
                            }
                        },
                        mouseup: function() {
                            var e = f.sorter.sort,
                        ...
                        save: function(e) {
                            ...
                            $.each(t, function(e, t) {
                                    ...
                                    if (o) {
                                        ...
                                        f.rendered && o.index != r && (f._itSl && f._itSl.indexOf(o.id), 1) && (i = !0),
                                            (o.index = r),
                                            a.push(o),
                                            d.push(o.id),
                                            r++;
                            ...
                            if (a.upload) {
                                var d = function(e) {
                                        a.html &&
                                            ...
                                            .addClass('upload-' + (e || a.upload.status));
                                    },
                                    r = function() {
                                        var e = 0;
                                        if (0 < f._pfuL.length)
                                            for (-1 < f._pfuL.indexOf(a) && f._pfuL.splice(f._pfuL.indexOf(a), 1); e < f._pfuL.length;
                                                ...
                                                if (-1 < f._itFl.indexOf(f._pfuL[e]) &&
                                                    f._pfuL[e].upload &&
                                                    !f._pfuL[e].upload.$ajax
                                                ) {
                                ...
                                if (n.upload.synchron && !a.upload.chunk)
                                    if (((a.upload.status = 'pending'), a.html && d(), e))
                                        -
                                        1 < f._pfuL.indexOf(a) && f._pfuL.splice(f._pfuL.indexOf(a), 1);
                                ...
                                if (
                                    ...
                                    !1 === n.upload.beforeSend(a, l, p, o, s)
                                )
                                    return delete a.upload.chunk, d(), void r();
                                if (
                                    ...
                                    for (var h in a.upload.data)
                                        a.upload.data.hasOwnProperty(h) &&
                                        a.upload.formData.append(h, a.upload.data[h]);
                                (a.upload.data = a.upload.formData),
                                (a.upload.xhr = function() {
                                    var e = $.ajaxSettings.xhr(),
                                        t =
                                        a.upload.chunk && a.upload.chunk.xhrStartedAt ?
                                        a.upload.chunk.xhrStartedAt :
                                        new Date();
                                    return (
                                        e.upload &&
                                        e.upload.addEventListener(
                                            ...
                                            function(e) {
                                                a.upload.$ajax &&
                                                    ((a.upload.$ajax.total = a.upload.chunk ?
                                                            a.upload.chunk.size :
                                                            e.total),
                                                        (a.upload.$ajax.xhrStartedAt = t)),
                                                    f.upload.progressHandling(e, a, t);
                                            }, !1
                                        ),
                                        e
                                    );
                                ...
                                (a.upload.complete = function(e, t) {
                                    if (a.upload.chunk && !a.upload.chunk.isLast && 'success' == t)
                                        return f.upload.send(a);
                                    r();
                                    var i = !0;
                                    $.each(f._itFl, function(e, t) {
                                ...
                                (a.upload.success = function(e, t, i) {
                                    if (!a.upload.chunk || a.upload.chunk.isLast)
                                        ...
                                        f.upload.progressHandling(null, a, a.upload.$ajax.xhrStartedAt, !0),
                                        (a.uploaded = !0),
                                        delete a.upload,
                                        (a.upload = {
                                            status: 'successful',
                                ...
                                (a.upload.error = function(e, t, i) {
                                    a.upload.chunk && (a.upload.chunk.i = Math.max(-1, a.upload.chunk.i - 1)),
                                        (a.uploaded = !1),
                                        (a.upload.status =
                                            'cancelled' == a.upload.status ? a.upload.status : 'failed'),
                        ...
                        progressHandling: function(e, t, i, r) {
                            if (
                                ...
                                t.upload.chunk &&
                                    ...
                                    n.upload.onProgress(w, t, l, p, o, s);
                            }
                        }
                    },
                    dragDrop: {
                    ...
                    clipboard: {
                            ...
                            if (
                                ...
                                for (var i = 0; i < t.length; i++)
                                    if (-1 !== t[i].type.indexOf('image') ||
                                        -1 !== t[i].type.indexOf('text/uri-list')
                                    ) {
                                        var r = t[i].getAsFile(),
                                            a = 1 < n.clipboardPaste ? n.clipboardPaste : 2e3;
                                        r &&
                                            ((r._name = f._assets.generateFileName(-1 != r.type.indexOf('/') ?
                                                    r.type.split('/')[1].toString().toLowerCase() :
                                                    'png',
                                                    'Clipboard '
                                                )),
                                                f.set('feedback', f._assets.textParse(n.captions.paste, { ms: a / 1e3 })),
                        ...
                        clean: function() {
                            f.clipboard._timer &&
                                (clearTimeout(f.clipboard._timer), delete f.clipboard._timer, f.set('feedback', null));
                        }
                    },
                    files: {
                        add: function(e, t) {
                            ...
                            return (
                                'updated' != t ?
                                (f._itFl.push(h), (o = f._itFl.length - 1), (r = f._itFl[o])) :
                                ((o = f._itFl.indexOf(e)), (f._itFl[o] = r = h)),
                                (r.remove = function() {
                                    f.files.remove(r);
                                }),
                                n.editor &&
                            ...
                            if (f.isFileReaderSupported() && !d.data.readerSkip) {
                                var a = new FileReader(),
                                    ...
                                    m = function() {
                                        ...
                                        d.reader._timer && (clearTimeout(d.reader._timer), delete d.reader._timer),
                                ...
                                if (
                                    (((d.reader.src || d.reader._FileReader) && !i) ||
                                        (d.reader = { _FileReader: a, _callbacks: [], read: d.reader.read }),
                                        d.reader.src && !i)
                                )
                                    return e && $.isFunction(e) ? e(d, l, p, o, s) : null;
                                if (
                                    e &&
                                    d.reader._callbacks &&
                                    (d.reader._callbacks.push(e), 1 < d.reader._callbacks.length)
                                )
                                    return;
                                if ('astext' == d.format)
                                    (a.onload = function(e) {
                                    ...
                                    if (
                                        ((a.onload = function(e) {
                                                function t() {
                                                    d.data &&
                                                        d.data.readerCrossOrigin &&
                                                        s.setAttribute('crossOrigin', d.data.readerCrossOrigin),
                                                        (s.src =
                                                            e.target.result +
                                                            ((!d.data.readerForce && !i) ||
                                                                h ||
                                                                c ||
                                                                -1 != e.target.result.indexOf('data:image') ?
                                                                '' :
                                                                (-1 == e.target.result.indexOf('?') ? '?' : '&') +
                                                                'd=' +
                                                                Date.now())),
                                                        (s.onload = function() {
                                                            if (d.reader.exifOrientation) {
                                                                var e = document.createElement('canvas'),
                                                                    t = e.getContext('2d'),
                                                                    o = s,
                                                                    i = d.reader.exifOrientation,
                                                                    n = [0, 180];
                                                                (e.width = o.naturalWidth),
                                                                (e.height = o.naturalHeight),
                                                                t.drawImage(o, 0, 0),
                                                                    (e.width = -1 < n.indexOf(i) ?
                                                                        o.naturalWidth :
                                                                        o.naturalHeight),
                                                                    (e.height = -1 < n.indexOf(i) ?
                                                                        o.naturalHeight :
                                                                        o.naturalWidth);
                                                                var r = (i * Math.PI) / 180,
                                                                    a = 0.5 * e.width,
                                                                ...
                                                                return (
                                                                    ...
                                                                    (s.src = e.toDataURL(d.type, 1)),
                                                                    void delete d.reader.exifOrientation
                                                                );
                                                            }
                                                            (d.reader.node = s),
                                                            (d.reader.src = s.src),
                                                            (d.reader.width = s.width),
                                                            (d.reader.height = s.height),
                                                            (d.reader.ratio = f._assets.pxToRatio(
                                                                d.reader.width,
                                                                d.reader.height
                                                            )),
                                                            w && u.revokeObjectURL(w),
                                                                m(),
                                    ...
                                    h
                                        ...
                                        a.onload({ target: { result: (w = u.createObjectURL(d.file)) } }) :
                                    ...
                                    if (
                                        ...
                                        if (r && !n.thumbnails.videoThumbnail)
                                            return (d.reader.node = v), m(), void(d.reader = { read: d.reader.read });
                                        (w = h ? u.createObjectURL(d.file) : d.file),
                                        (v.onloadedmetadata = function() {
                                            (d.reader.node = v),
                                            (d.reader.src = v.src),
                                            (d.reader.duration = v.duration),
                                            (d.reader.duration2 = f._assets.secondsToText(v.duration)),
                                            'video' == d.format &&
                                                ((d.reader.width = v.videoWidth),
                                                    (d.reader.height = v.videoHeight),
                                                    (d.reader.ratio = f._assets.pxToRatio(
                                                        d.reader.width,
                                                        d.reader.height
                                                    )));
                                        ...
                                        (v.onloadeddata = function() {
                                            if ('video' == d.format) {
                                                ...
                                                t.drawImage(v, 0, 0, e.width, e.height),
                                                    (d.reader.frame = f._assets.isBlankCanvas(e) ?
                                                        null :
                                                        e.toDataURL()),
                                                    (e = t = null);
                                            }
                                        ...
                                        setTimeout(function() {
                                            d.data &&
                                                d.data.readerCrossOrigin &&
                                                v.setAttribute('crossOrigin', d.data.readerCrossOrigin),
                                                (v.src = w + '#t=1');
                                        }, 100);
                                    } else a.onerror();
                                } else if ('application/pdf' == d.type && n.thumbnails.pdf) {
                                    var v = document.createElement('iframe'),
                                        w = h ? u.createObjectURL(d.file) : (n.thumbnails.pdf.urlPrefix || '') + d.file;
                                    n.thumbnails.pdf.viewer || f._assets.hasPlugin('pdf') ?
                                        ((v.onload = function() {
                                                (d.reader.node = v),
                                                (d.reader.src = v.src),
                                                (v.style.display = ''),
                                            ...
                                            (v.src = (n.thumbnails.pdf.viewer || '') + w),
                                ...
                                d.reader._timer = setTimeout(
                                    a.onerror,
                                    r ? n.reader.thumbnailTimeout : n.reader.timeout
                                );
                            } else e && e(d, l, p, o, s);
                            return null;
                        },
                        list: function(r, a, e, t) {
                            var d = [];
                            return (!n.sorter || e || (t && 'ignoreSorter' == t) || f.sorter.save(!0),
                                $.each(f._itFl, function(e, t) {
                                    var o = t;
                                    ...
                                    if (
                                        ((a || r) &&
                                            (o =
                                                (o.choosed && !o.uploaded ? '0:/' : '') +
                                                (a && null !== f.files.getItemAttr(t, a) ?
                                                    f.files.getItemAttr(o, a) :
                                                    o.local || o['string' == typeof o.file ? 'file' : 'name'])),
                                            r &&
                                            ((o = { file: o }),
                                                t.editor &&
                                                (t.editor.crop || t.editor.rotation) &&
                                                ((o.editor = {}),
                                                    t.editor.rotation && (o.editor.rotation = t.editor.rotation),
                                                    t.editor.crop && (o.editor.crop = t.editor.crop)),
                                ...
                                (d =
                                    ...
                                    n.onListInput(d, f._itFl, n.listInput, l, p, o, s) :
                                    d),
                        ...
                        check: function(i, r, e) {
                            ...
                            if (null != n.limit && e && r.length + f._itFl.length - 1 > n.limit)
                                return (a[1] = f._assets.textParse(n.captions.errors.filesLimit)), (a[3] = !0), a;
                            if (null != n.maxSize && e) {
                                var d = 0;
                                if (
                                    ($.each(f._itFl, function(e, t) {
                            ...
                            if (
                                ...
                                return (a[1] = f._assets.textParse(n.captions.errors.filesType, i)), a;
                            if (null != n.fileMaxSize && i.size > f._assets.toBytes(n.fileMaxSize))
                                return (a[1] = f._assets.textParse(n.captions.errors.fileSize, i)), a;
                            if (0 == i.size && '' == i.type)
                                return (a[1] = f._assets.textParse(n.captions.errors.remoteFile, i)), a;
                            if (4096 == i.size && '' == i.type)
                                return (a[1] = f._assets.textParse(n.captions.errors.folderUpload, i)), a;
                                    ...
                                    ($.each(f._itFl, function(e, t) {
                                            if (t != i && 1 == t.choosed && t.file && t.name == i.name)
                                                return (
                                                    ...
                                                    (i.file.lastModified &&
                                                        t.file.lastModified &&
                                                        t.file.lastModified != i.file.lastModified) ||
                                                    !(1 < r.length) ?
                        ...
                        append: function(e) {
                            if ((e = $.isArray(e) ? e : [e]).length) {
                                for (var t, i = 0; i < e.length; i++)
                                    f._assets.keyCompare(e[i], ['name', 'file', 'size', 'type']) &&
                        ...
                        update: function(e, t) {
                            if (!(-1 == f._itFl.indexOf(e) || (e.upload && e.upload.$ajax))) {
                                ...
                                (e = f._itFl[i]).popup && e.popup.close && e.popup.close(),
                        ...
                        remove: function(i, r) {
                            if (r || !n.onRemove || !$.isFunction(n.onRemove) || !1 !== n.onRemove(i, l, p, o, s)) {
                                if (
                                    (i.html &&
                                        (n.thumbnails.onItemRemove && $.isFunction(n.thumbnails.onItemRemove) && !r ?
                                            n.thumbnails.onItemRemove(i.html, l, p, o, s) :
                                            i.html.remove()),
                                        i.upload && i.upload.$ajax && i.upload.cancel && i.upload.cancel(!0),
                                        i.popup && i.popup.close && i.popup.close(),
                                    ...
                                    $.each(f._itFl, function(e, t) {
                                        ...
                                        a &&
                                        (f.isAddMoreMode() && 1 < sl.length ?
                                            (f.set('nextInput'),
                                                sl.splice(sl.indexOf(i.input), 1),
                                                i.input.remove()) :
                                            f.set('input', ''));
                                } -
                                1 < f._pfrL.indexOf(i) && f._pfrL.splice(f._pfrL.indexOf(i), 1), -1 < f._pfuL.indexOf(i) && f._pfuL.splice(f._pfuL.indexOf(i), 1), -1 < f._itFl.indexOf(i) && f._itFl.splice(f._itFl.indexOf(i), 1),
                                    (i = null),
                        ...
                        getItemAttr: function(e, t) {
                            var o = null;
                            return (
                                e && (void 0 !== e[t] ? (o = e[t]) : e.data && void 0 !== e.data[t] && (o = e.data[t])),
                                o
                            );
                        },
                        clear: function(e) {
                            for (var t = 0; t < f._itFl.length;) {
                                var i = f._itFl[t];
                                e || !i.appended ?
                                    (i.html && i.html && f._itFl[t].html.remove(),
                                        i.upload && i.upload.$ajax && f.upload.cancel(i),
                                        f._itFl.splice(t, 1)) :
                                    t++;
                            }
                            f.set('feedback', null),
                    ...
                    _assets: {
                        ...
                        ratioToPx: function(e, t, o) {
                            return (o = (o + '').split(':')).length < 2 ?
                                null : [(t / o[1]) * o[0], (e / o[0]) * o[1], o[0], o[1]];
                        },
                        ...
                        arrayBufferToBase64: function(e) {
                            for (var t = '', o = new Uint8Array(e), i = 0; i < o.byteLength; i++)
                        ...
                        textParse: function(text, opts, noOptions) {
                            switch (
                                ...
                                case 'string':
                                    for (var key in opts)
                                        -
                                        1 < ['name', 'file', 'type', 'size'].indexOf(key) &&
                            ...
                            return (
                                ...
                                ((t = (function(e) {
                                        ...
                                        return e && e.constructor == Array && 3 == e.length ?
                                            e :
                                            (t = /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/.exec(
                                                e
                                            )) ? [parseInt(t[1]), parseInt(t[2]), parseInt(t[3])] :
                                            (t = /rgb\(\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*\)/.exec(
                                                e
                                            )) ? [2.55 * parseFloat(t[1]), 2.55 * parseFloat(t[2]), 2.55 * parseFloat(t[3])] :
                                            (t = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/.exec(e)) ? [parseInt(t[1], 16), parseInt(t[2], 16), parseInt(t[3], 16)] :
                        ...
                        hasPlugin: function(e) {
                            if (navigator.plugins && navigator.plugins.length)
                                for (var t in navigator.plugins)
                                    if (-1 < navigator.plugins[t].name.toLowerCase().indexOf(e)) return !0;
                            return !1;
                        },
                        isIE: function() {
                ...
                (s.get(0).FileUploader = {
                    ...
                    add: function(e, t, o) {
                        ...
                        if (e instanceof Blob) i = e;
                            ...
                            var n = /data:[a-z]+\/[a-z]+\;base64\,/.test(e) ?
                                e :
                        ...
                        return (
                            (i._name =
                                o ||
                                f._assets.generateFileName(-1 != i.type.indexOf('/') ?
                    ...
                    remove: function(e) {
                        return (
                            (e = e.jquery ? f.files.find(e) : e), -1 < f._itFl.indexOf(e) && (f.files.remove(e), !0)
                        );
                    },
    ...
    ($.fn.fileuploader.defaults = {
        ...
        thumbnails: {
            ...
            popup: {
                ...
                template: function(e) {
                    return (
                        '<div class="fileuploader-popup-preview"><a class="fileuploader-popup-move" data-action="prev"></a><div class="fileuploader-popup-node ${format}">${reader.node}</div><div class="fileuploader-popup-content"><div class="fileuploader-popup-footer"><ul class="fileuploader-popup-tools">' +
                        ('image' == e.format && e.editor ?
                            (e.editor.cropper ?
                                '<li><a data-action="crop"><i></i> ${captions.crop}</a></li>' :
                                '') +
                            (e.editor.rotate ?
                                '<li><a data-action="rotate-cw"><i></i> ${captions.rotate}</a></li>' :
                                '') :
                            '') +
                        ('image' == e.format ?
                            '<li class="fileuploader-popup-zoomer"><a data-action="zoom-out">&minus;</a><input type="range" min="0" max="100"><a data-action="zoom-in">&plus;</a><span></span> </li>' :
                            '') +
                        '<li><a data-action="remove"><i></i> ${captions.remove}</a></li></ul></div><div class="fileuploader-popup-header"><ul class="fileuploader-popup-meta"><li><span>${captions.name}:</span><h5>${name}</h5></li><li><span>${captions.type}:</span><h5>${extension.toUpperCase()}</h5></li><li><span>${captions.size}:</span><h5>${size2}</h5></li>' +
        ...
        captions: {
            ...
            errors: {
                filesLimit: 'Max ${limit} are allowed .',
                filesType: 'Only ${extensions} files are allowed to be uploaded.',
                fileSize: '${name} Is to much , please choose one until ${fileMaxSize}MB.',
                filesSizeAll: 'Your files are to large! Please upload files up to ${maxSize} MB.',
